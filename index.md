...
humandate: "October 26-27, November 2-3, 2020"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Jason Bell (CQU/QCIF)","Dag Evensberget (USQ)","Stéphane Guillou (UQ)", "Thom Cuddihy (QCIF)"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Toan Phung (QCIF)","Mathew Fletcher (QUT)","Masami Yamaguchi (Griffith)", "McKenna Buckley (Griffith)", "Dattatreya Majumdar (QCIF)", "Shern Tee (UQ)" ]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
eventbrite: "122005514779"           # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
